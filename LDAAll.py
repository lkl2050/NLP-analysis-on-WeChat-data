...
stopwords = [line.strip() for line in open(r'/global/project/rotman_research/pc_zgong/WechatCode/LDA/extrastopword.txt', encoding='utf-8').readlines()]
swset = set(stopwords)


data1 = pd.read_pickle(r'/global/project/rotman_research/pc_zgong/WechatCode/LDA/cut021.pkl')
